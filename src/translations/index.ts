  ...
  pt: {
    ...
    projects: {
      ...
      data: [{
        ...
        description: "Desenvolvi um portfólio moderno e performático utilizando React e Vite, com TanStack e TailwindCSS, incluindo animações fluidas, navegação intuitiva e interface responsiva para destacar habilidades, projetos e experiências profissionais.",
        technologies: ["React", "Vite", "tanstack", "tailwindcss", "framer-motion", "lucide-react"],
        links: {
          github: "",
          website: ""
        }
  ...
  en: {
    ...
    projects: {
      ...
      data: [{
        ...
        description: "Built a modern, high-performance portfolio using React and Vite, enhanced with TanStack and TailwindCSS, featuring smooth animations, intuitive navigation, and a responsive interface designed to showcase skills, projects, and professional experience effectively.",
        technologies: ["React", "Vite", "tanstack", "tailwindcss", "framer-motion", "lucide-react"],
        links: {
          github: "",
          website: ""
